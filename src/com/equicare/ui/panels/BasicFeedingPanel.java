...
public class BasicFeedingPanel extends JPanel {
	...
	private void initComponents() {
		...
		this.txtFeedType = new InfoTextField(30);
		this.txtAmount = new InfoTextField(30);
			
		this.jplSupplements = new TextInputPanel(false,"Supplements", 145);
		this.jplNotes = new TextInputPanel(false,"Feeding Notes",145);
