...
public class BasicIdentificationPanel extends JPanel {
	...
	public BasicIdentificationPanel() {
	...
	private void initComponents() {
		...
		this.txtChipNumber = new InfoTextField(30);
		this.txtPassportNumber = new InfoTextField(30);		
		this.txtRegistrationNumber = new InfoTextField(30);
		this.txtInsuranceNumber = new InfoTextField(30);		
		this.jplImageFile = new ImageFilePanel(false);
